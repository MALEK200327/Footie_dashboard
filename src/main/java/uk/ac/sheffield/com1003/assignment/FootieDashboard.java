...
public class FootieDashboard {
    ...
    /**
     * This method prints the answers to the three pre-defined questions in the console by calling appropriate methods from the
     * playerCatalog object. It first prints the highest number of assists in the EPL, followed by the highest number of fouls
     * committed in La Liga, and finally the average number of shots on target across both the EPL and La Liga. Each answer is
    ...
    /**
     * Display the first five player entries for each league
     */
